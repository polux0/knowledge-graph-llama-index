import os
from modules.utils.environment_setup import load_environment_variables
from langfuse import Langfuse

env_vars = load_environment_variables()

os.environ["LANGFUSE_PUBLIC_KEY"] = env_vars["PUBLIC_KEY"]
os.environ["LANGFUSE_SECRET_KEY"] = env_vars["SECRET_KEY"]
